...
void keyPressed()
{
  ...
  if (!streaming) {
    if (keyCode == LEFT) port.write("G21/G90/G1 X-20  F3500\n");
    if (keyCode == RIGHT) port.write("G21/G90/G1 X20 F3500\n");
    if (keyCode == UP) port.write("G21/G90/G1 Y0 F3500\n");
    if (keyCode == DOWN) port.write("G21/G90/G1 Y-20 F3500\n");
